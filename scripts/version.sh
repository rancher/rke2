...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.30.13}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.30.13-rke2r1-build20250515}
ETCD_VERSION=${ETCD_VERSION:-v3.5.21-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.30.13-rc1.0.20250516172343-e77f78ee9466-build20250613}
