...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.23.12}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.23.12-rke2r1-build20220921}
ETCD_VERSION=${ETCD_VERSION:-v3.5.4-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.25.2-build20220930}
