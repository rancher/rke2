...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.35.8}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.35.8-rke2r1-build20260821}
PAUSE_VERSION=${PAUSE_VERSION:-3.10.2}
CCM_VERSION=${CCM_VERSION:-v1.35.8-0.20260817193936-20fc9c33a412-build20260820}
