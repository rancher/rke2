...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.34.6}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.34.6-rke2r3-build20260407}
ETCD_VERSION=${ETCD_VERSION:-v3.6.7-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.34.7-0.20260415182025-e7567db58dd7-build20260416}
KLIPPERHELM_VERSION=${KLIPPERHELM_VERSION:-v0.9.16-build20260410}
