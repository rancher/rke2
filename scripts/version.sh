...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.22.2}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.22.2-rke2r1-build20210924}
ETCD_VERSION=${ETCD_VERSION:-v3.5.0-k3s2}
PAUSE_VERSION=${PAUSE_VERSION:-3.5}
CCM_VERSION=${CCM_VERSION:-v0.0.2-build20210915}
