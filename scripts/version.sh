...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.32.7}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.32.7-rke2r1-build20250716}
ETCD_VERSION=${ETCD_VERSION:-v3.5.21-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.32.5-rc1.0.20250516182639-8e8f2a4726fd-build20250612}
