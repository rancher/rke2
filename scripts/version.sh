...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.32.10}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.32.10-rke2r1-build20251112}
ETCD_VERSION=${ETCD_VERSION:-v3.5.21-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.32.10-0.20251010190908-d439f1a03318-build20251017}
