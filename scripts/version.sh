...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.33.7}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.33.7-rke2r1-build20251210}
ETCD_VERSION=${ETCD_VERSION:-v3.5.25-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.33.7-0.20251210094413-291666bcc1a4-build20251210}
