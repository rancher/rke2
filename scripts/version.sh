...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.28.13}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.28.13-rke2r1-build20240815}
ETCD_VERSION=${ETCD_VERSION:-v3.5.13-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.28.13-build20240906}
