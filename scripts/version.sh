...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.33.13}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.33.13-rke2r1-build20260612}
ETCD_VERSION=${ETCD_VERSION:-v3.6.12-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.33.13-0.20260610231102-b1a9339db253-build20260710}
KLIPPERHELM_VERSION=${KLIPPERHELM_VERSION:-v0.12.1-build20260709}
