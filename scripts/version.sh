...
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.34.1-rke2r1-build20250910}
ETCD_VERSION=${ETCD_VERSION:-v3.6.4-k3s3}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.33.0-rc1.0.20250905195603-857412ae5891-build20250908}
