...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.29.14}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.29.14-rke2r1-build20250213}
ETCD_VERSION=${ETCD_VERSION:-v3.5.19-k3s1}
