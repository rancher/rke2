...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.33.6}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.33.5-rke2r1-build20250910}
ETCD_VERSION=${ETCD_VERSION:-v3.5.21-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.33.6-0.20251010190850-d6b5244412d1-build20251017}
