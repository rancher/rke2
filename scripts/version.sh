...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.33.10}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.33.10-rke2r3-build20260407}
ETCD_VERSION=${ETCD_VERSION:-v3.5.26-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.33.10-0.20260316230806-13a8403081db-build20260410}
