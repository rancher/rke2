...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.34.8}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.34.8-rke2r2-build20260521}
...
KLIPPERHELM_VERSION=${KLIPPERHELM_VERSION:-v0.11.0-build20260602}
