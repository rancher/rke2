...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.31.11}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.31.11-rke2r1-build20250716}
ETCD_VERSION=${ETCD_VERSION:-v3.5.21-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.31.9-rc1.0.20250516171836-812206503b28-build20250612}
