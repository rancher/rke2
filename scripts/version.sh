...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.32.8}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.32.8-rke2r1-build20250814}
ETCD_VERSION=${ETCD_VERSION:-v3.5.21-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.32.8-rc1.0.20250814215348-fe896f7e7cf8-build20250908}
