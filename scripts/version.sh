...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.35.7}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.35.7-rke2r1-build20260723}
PAUSE_VERSION=${PAUSE_VERSION:-3.10.2}
CCM_VERSION=${CCM_VERSION:-v1.35.6-0.20260610221957-158346759a70-build20260710}
