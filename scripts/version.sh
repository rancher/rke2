...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.31.13}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.31.13-rke2r1-build20250910}
ETCD_VERSION=${ETCD_VERSION:-v3.5.21-k3s1}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.31.12-rc1.0.20250814215358-2b53c7e4c817-build20250908}
