...
ETCD_IMAGE_TAG=${ETCD_VERSION:-v3.6.14-k3s3-build20260915}
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.34.12}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.34.12-rke2r1-build20260923}
PAUSE_VERSION=${PAUSE_VERSION:-3.10.2}
CCM_VERSION=${CCM_VERSION:-v1.34.12-0.20260915234148-f2918dc7011c-build20260916}
KLIPPERHELM_VERSION=${KLIPPERHELM_VERSION:-v0.13.3-build20260909}
