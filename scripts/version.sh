...
KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.20.14}
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.20.14-rke2r1-build20211215}
ETCD_VERSION=${ETCD_VERSION:-v3.4.13-k3s3}
PAUSE_VERSION=${PAUSE_VERSION:-3.2}
CCM_VERSION=${CCM_VERSION:-v0.0.3-build20211118}
IMAGE_BUILD_VERSION=${IMAGE_BUILD_VERSION:-build20211118}
