...
func (h *HostedConfig) Reset(ctx context.Context, reboostrap func() error) error {
...
func (h *HostedConfig) Start(ctx context.Context, clientAccessInfo *clientaccess.Info) error {
	return h.etcd.Start(ctx, clientAccessInfo)
}
