...
func (c CISMode) isAnyMode() bool {
	return c == STDMode || c == ETCDMode
}
func (c CISMode) IsSTDMode() bool {
	return c == STDMode
}
...
func (s *StaticPodConfig) APIServer(_ context.Context, args []string) error {
	...
	if s.CISMode.IsSTDMode() && s.AuditPolicyFile == "" {
