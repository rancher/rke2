...
var (
	...
	commonFlag = []cli.Flag{
		...
		&cli.StringSliceFlag{
			Name:   rke2.KubeAPIServer + "-extra-bind",
			Usage:  "(components) " + rke2.KubeAPIServer + " extra volume bindings",
			EnvVar: "RKE2_" + strings.ToUpper(strings.ReplaceAll(rke2.KubeAPIServer, "-", "_")) + "_EXTRA_BIND",
			Value:  &config.ExtraBinds.KubeAPIServer,
		},
		&cli.StringSliceFlag{
			Name:   rke2.KubeScheduler + "-extra-bind",
			Usage:  "(components) " + rke2.KubeScheduler + " extra volume bindings",
			EnvVar: "RKE2_" + strings.ToUpper(strings.ReplaceAll(rke2.KubeScheduler, "-", "_")) + "_EXTRA_BIND",
			Value:  &config.ExtraBinds.KubeScheduler,
		},
		&cli.StringSliceFlag{
			Name:   rke2.KubeControllerManager + "-extra-bind",
			Usage:  "(components) " + rke2.KubeControllerManager + " extra volume bindings",
			EnvVar: "RKE2_" + strings.ToUpper(strings.ReplaceAll(rke2.KubeControllerManager, "-", "_")) + "_EXTRA_BIND",
			Value:  &config.ExtraBinds.KubeControllerManager,
		},
		&cli.StringSliceFlag{
			Name:   rke2.KubeProxy + "-extra-bind",
			Usage:  "(components) " + rke2.KubeProxy + " extra environment bindings",
			EnvVar: "RKE2_" + strings.ToUpper(strings.ReplaceAll(rke2.KubeProxy, "-", "_")) + "_EXTRA_BIND",
			Value:  &config.ExtraBinds.KubeProxy,
		},
		&cli.StringSliceFlag{
			Name:   rke2.Etcd + "-extra-bind",
			Usage:  "(components) " + rke2.Etcd + " extra volume bindings",
			EnvVar: "RKE2_" + strings.ToUpper(strings.ReplaceAll(rke2.Etcd, "-", "_")) + "_EXTRA_BIND",
			Value:  &config.ExtraBinds.Etcd,
		},
		&cli.StringSliceFlag{
			Name:   rke2.CloudControllerManager + "-extra-bind",
			Usage:  "(components) " + rke2.CloudControllerManager + " extra volume bindings",
			EnvVar: "RKE2_" + strings.ToUpper(strings.ReplaceAll(rke2.CloudControllerManager, "-", "_")) + "_EXTRA_BIND",
