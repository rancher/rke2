...
replace (
	...
	k8s.io/node-api => github.com/k3s-io/kubernetes/staging/src/k8s.io/node-api v1.37.1-k3s1
...
require (
	...
	github.com/k3s-io/k3s v1.37.1-rc2.0.20260924184608-356c025475bb // main
