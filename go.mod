...
replace (
	...
	k8s.io/node-api => github.com/k3s-io/kubernetes/staging/src/k8s.io/node-api v1.24.1-k3s1
...
require (
	...
	github.com/k3s-io/k3s v1.24.2-0.20220616192813-a5414bb1fc90 // master
