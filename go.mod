...
replace (
	...
	k8s.io/cri-api => github.com/k3s-io/kubernetes/staging/src/k8s.io/cri-api v1.35.6-k3s2
...
require (
	...
	github.com/k3s-io/k3s v1.35.7-0.20260720191031-7464a828f03e // release-1.35
