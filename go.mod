...
replace (
	...
	github.com/containerd/containerd/v2 => github.com/k3s-io/containerd/v2 v2.2.4-k3s1.33
...
require (
	...
	github.com/k3s-io/k3s v1.33.13-0.20260603215245-265039bfe38d // release-1.33
