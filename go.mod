...
require (
	...
	github.com/k3s-io/k3s v1.31.0-rc1.0.20241015183003-536fa44eb04f // master
...
require (
	...
	k8s.io/kubectl v0.31.1-rc.1 // indirect
...
replace github.com/k3s-io/k3s => github.com/brandond/k3s v1.31.0-rc1.0.20241025221626-5e6dc72564ab
