...
replace (
	...
	k8s.io/endpointslice => github.com/k3s-io/kubernetes/staging/src/k8s.io/endpointslice v1.29.9-k3s2
...
require (
	...
	github.com/k3s-io/k3s v1.29.10-0.20241012053846-6cbbd2736730 // release-1.29
