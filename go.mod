...
replace (
	...
	k8s.io/node-api => github.com/k3s-io/kubernetes/staging/src/k8s.io/node-api v1.34.10-k3s1
...
require (
	...
	github.com/k3s-io/k3s v1.34.10-0.20260720191035-931a1fbe1614 // release-1.34
