...
require (
	...
	github.com/k3s-io/k3s v1.35.0-rc1.0.20251218152248-a6c6cd15c0c4 // head
...
replace github.com/k3s-io/k3s => github.com/brandond/k3s v1.33.0-rc1.0.20251219220824-bc6a7be31f81
