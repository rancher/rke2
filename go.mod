...
replace (
	...
	github.com/rancher/wharfie => github.com/rancher/wharfie v0.6.9
...
require (
	...
	github.com/k3s-io/k3s v1.32.14-0.20260312010802-d36393d26598 // release-v1.32
...
require (
	...
	k8s.io/kube-proxy v0.32.13 // indirect
