...
require (
	...
	github.com/k3s-io/k3s v1.32.0-rc1.0.20241220224140-68fbd1a6b543 // release-v1.32
...
replace k8s.io/externaljwt => github.com/k3s-io/kubernetes/staging/src/k8s.io/externaljwt v1.32.0-k3s1
