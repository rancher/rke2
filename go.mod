...
replace (
	...
	k8s.io/node-api => github.com/k3s-io/kubernetes/staging/src/k8s.io/node-api v1.34.11-k3s1
...
require (
	...
	github.com/k3s-io/k3s v1.34.12-0.20260915234148-f2918dc7011c // release-1.34
