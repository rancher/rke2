...
replace (
	...
	k8s.io/node-api => github.com/k3s-io/kubernetes/staging/src/k8s.io/node-api v1.34.12-k3s1
...
require (
	...
	github.com/k3s-io/k3s v1.34.12-rc2.0.20260924184658-47b4749964eb // release-1.34
...
require (
	...
	k8s.io/kube-proxy v0.34.9 // indirect
