...
replace (
	...
	k8s.io/node-api => github.com/k3s-io/kubernetes/staging/src/k8s.io/node-api v1.36.4-k3s1
...
require (
	...
	github.com/k3s-io/k3s v1.36.4-0.20260817193921-a2fc9574e060 // release-1.36
