...
require (
	...
	github.com/k3s-io/k3s v1.34.7-rc2.0.20260422204255-e132b4b58b6c // release-1.34
...
require (
	...
	k8s.io/cluster-bootstrap v0.34.7 // indirect
	...
	k8s.io/kube-proxy v0.34.7 // indirect
