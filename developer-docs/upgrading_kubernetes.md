...
* Enter the desired version into the "Tag version" box. 
    * Example tag: `v1.20.15-rc1+rke2r1`
...
* Click "Draft new release"
* Enter the desired version into the "Tag version" box. 
    * Example tag: `v1.20.15-rc1+rke2r1.testing.0`
...
* Click "Draft new release"
* Enter the desired version into the "Tag version" box. 
    * Example tag: `v1.20.15+rke2r1.testing.0`
    * The first part of the tag here must match the tag created in the RKE2 repo.

Make sure that CI passes. This is for RPM availability in the testing channel.

Once complete, perform the steps above again however this time, use the tag "latest" tag. E.g. `v1.20.15+rke2r1.latest.0`.
...
* Update the line: `latest: <release>` to be the recent release. e.g. `v1.20.15+rke2r1`.
