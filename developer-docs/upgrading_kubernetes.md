...
* Dockerfile: `RUN CHART_VERSION="v1.20.13"     CHART_FILE=/charts/rke2-kube-proxy.yaml`
* Dockerfile: `FROM rancher/k3s:v1.20.13-k3s1 AS k3s`
* images.go:  `KubernetesVersion = "v1.20.13"`
* version.sh: `KUBERNETES_VERSION=${KUBERNETES_VERSION:-v1.20.13}`
...
* Enter the desired version into the "Tag version" box. 
    * Example tag: `v1.20.13-rc1+rke2r1`
...
* Click "Draft new release"
* Enter the desired version into the "Tag version" box. 
    * Example tag: `v1.20.13-rc1+rke2r1.testing.0`
...
* Click "Draft new release"
* Enter the desired version into the "Tag version" box. 
    * Example tag: `v1.20.13+rke2r1.testing.0`
    * The first part of the tag here must match the tag created in the RKE2 repo.

Make sure that CI passes. This is for RPM availability in the testing channel.

Once complete, perform the steps above again however this time, use the tag "latest" tag. E.g. `v1.20.13+rke2r1.latest.0`.
...
* Update the line: `latest: <release>` to be the recent release. e.g. `v1.20.13+rke2r1`.
