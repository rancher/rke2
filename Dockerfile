...
# Build environment
FROM rancher/hardened-build-base:v1.24.6b1 AS build
...
FROM rancher/hardened-kubernetes:v1.33.5-rke2r1-build20250910 AS kubernetes
FROM rancher/hardened-containerd:v2.1.4-k3s2-build20250904 AS containerd
FROM rancher/hardened-crictl:v1.33.0-build20250909 AS crictl
