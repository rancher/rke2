...
RUN CHART_VERSION="v1.20.13-rke2r1-build2021111901" \
...
FROM rancher/k3s:v1.20.13-k3s1 AS k3s
FROM rancher/hardened-kubernetes:v1.20.13-rke2r1-build20211119 AS kubernetes
FROM rancher/hardened-containerd:v1.4.12-k3s1-build20211118 AS containerd
FROM rancher/hardened-crictl:v1.20.0-build20211118 AS crictl
