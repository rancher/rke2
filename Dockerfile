...
RUN CHART_VERSION="v3.22.201"                 CHART_FILE=/charts/rke2-calico.yaml         CHART_BOOTSTRAP=true   /charts/build-chart.sh
RUN CHART_VERSION="v3.22.002"                 CHART_FILE=/charts/rke2-calico-crd.yaml     CHART_BOOTSTRAP=true   /charts/build-chart.sh
...
RUN CHART_VERSION="v3.8-build2021110401"      CHART_FILE=/charts/rke2-multus.yaml         CHART_BOOTSTRAP=true   /charts/build-chart.sh
...
FROM rancher/hardened-kubernetes:v1.23.6-rke2r3-build20220511 AS kubernetes
