...
RUN CHART_VERSION="4.1.007"                   CHART_FILE=/charts/rke2-ingress-nginx.yaml  CHART_BOOTSTRAP=false  /charts/build-chart.sh
...
FROM rancher/hardened-kubernetes:v1.25.5-rke2r1-build20221208 AS kubernetes
