...
RUN CHART_VERSION="v1.19.11-build2021052000"  CHART_FILE=/charts/rke2-kube-proxy.yaml        CHART_BOOTSTRAP=true    /charts/build-chart.sh
...
FROM rancher/k3s:v1.19.11-k3s1 AS k3s
