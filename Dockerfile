...
RUN CHART_VERSION="1.12.001"                  CHART_FILE=/charts/rke2-cilium.yaml         CHART_BOOTSTRAP=true   /charts/build-chart.sh
...
FROM rancher/hardened-kubernetes:v1.22.12-rke2r1-build20220713 AS kubernetes
