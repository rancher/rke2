...
RUN CHART_VERSION="1.12.101"                  CHART_FILE=/charts/rke2-cilium.yaml         CHART_BOOTSTRAP=true   /charts/build-chart.sh
...
FROM rancher/hardened-kubernetes:v1.22.13-rke2r2-build20220819 AS kubernetes
