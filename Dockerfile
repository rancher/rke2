...
FROM bcibase/hardened-kubernetes:v1.23.12-rke2r1-build20220921 AS kubernetes
FROM bcibase/hardened-containerd:v1.5.13-k3s1-build20220606 AS containerd
FROM bcibase/hardened-crictl:v1.23.0-build20220414 AS crictl
