...
RUN CHART_VERSION="v1.21.11-rke2r2-build2022032401" \
...
FROM rancher/hardened-kubernetes:v1.21.11-rke2r2-build20220324 AS kubernetes
FROM rancher/hardened-containerd:v1.4.13-k3s1-build20220308 AS containerd
