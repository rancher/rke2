...
# Build environment
FROM rancher/hardened-build-base:v1.23.11b1 AS build
...
FROM rancher/hardened-kubernetes:v1.31.12-rke2r1-build20250814 AS kubernetes
FROM rancher/hardened-containerd:v2.0.5-k3s2-build20250711 AS containerd
FROM rancher/hardened-crictl:v1.31.1-build20250612 AS crictl
