...
RUN CHART_VERSION="v3.26.3-build2023110900"   CHART_FILE=/charts/rke2-canal.yaml          CHART_BOOTSTRAP=true   /charts/build-chart.sh
...
FROM rancher/hardened-kubernetes:v1.28.3-rke2r2-build20231102 AS kubernetes
