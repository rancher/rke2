...
# Build environment
FROM rancher/hardened-build-base:v1.19.8b1 AS build
...
RUN CHART_VERSION="v3.25.1-build2023051200"   CHART_FILE=/charts/rke2-canal.yaml          CHART_BOOTSTRAP=true   /charts/build-chart.sh
...
FROM rancher/hardened-kubernetes:v1.24.14-rke2r1-build20230518 AS kubernetes
