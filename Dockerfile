...
FROM bcibase/hardened-kubernetes:v1.25.2-rke2r1-build20220921 AS kubernetes
FROM bcibase/hardened-containerd:v1.6.8-k3s1-build20220901 AS containerd
FROM bcibase/hardened-crictl:v1.24.0-build20220506 AS crictl
FROM bcibase/hardened-runc:v1.1.4-build20220901 AS runc
