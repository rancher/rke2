...
RUN CHART_VERSION="v3.13.3-build2021102205" \
...
RUN CHART_VERSION="v1.20.14-rke2r2-build2022010701" \
...
FROM rancher/hardened-kubernetes:v1.20.14-rke2r2-build20220107 AS kubernetes
