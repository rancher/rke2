...
RUN CHART_VERSION="v1.21.5-rke2r1-build2021091601" \
...
FROM rancher/k3s:v1.21.5-k3s1 AS k3s
FROM rancher/hardened-kubernetes:v1.21.5-rke2r1-build20210916 AS kubernetes
