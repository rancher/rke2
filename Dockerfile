...
RUN CHART_VERSION="v1.20.12-rke2r1-build2021102801" \
...
FROM rancher/k3s:v1.20.11-k3s2 AS k3s
FROM rancher/hardened-kubernetes:v1.20.12-rke2r1-build20211028 AS kubernetes
