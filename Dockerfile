...
RUN CHART_VERSION="1.10.401"                  CHART_FILE=/charts/rke2-cilium.yaml         CHART_BOOTSTRAP=true   /charts/build-chart.sh
...
RUN CHART_VERSION="v1.21.4-rke2r3-build2021090101" \
...
FROM rancher/hardened-kubernetes:v1.21.4-rke2r3-build20210901 AS kubernetes
