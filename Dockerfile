...
FROM rancher/hardened-containerd:v2.3.4-k3s1.36-build20260817 AS containerd
FROM rancher/hardened-crictl:v1.36.0-build20260815 AS crictl
FROM rancher/hardened-runc:v1.4.3-build20260814 AS runc
