...
RUN CHART_URL="https://rke2-charts.rancher.io/assets/rke2-kube-proxy-1.20/rke2-kube-proxy-v1.20.8-build2021071403.tgz"  \
...
FROM rancher/hardened-kubernetes:v1.20.8-rke2r1-build20210714 AS kubernetes
