...
# Build environment
FROM rancher/hardened-build-base:v1.22.12b1 AS build
...
FROM rancher/hardened-kubernetes:v1.29.14-rke2r1-build20250213 AS kubernetes
FROM rancher/hardened-containerd:v1.7.26-k3s1-build20250310 AS containerd
FROM rancher/hardened-crictl:v1.29.0-build20250211 AS crictl
