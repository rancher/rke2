...
# Build environment
FROM rancher/hardened-build-base:v1.23.8b1 AS build
...
FROM rancher/hardened-kubernetes:v1.30.13-rke2r1-build20250515 AS kubernetes
FROM rancher/hardened-containerd:v1.7.27-k3s1-build20250513 AS containerd
