...
FROM rancher/hardened-kubernetes:v1.29.8-rke2r1-build20240815 AS kubernetes
FROM rancher/hardened-containerd:v1.7.21-k3s2-build20240906 AS containerd
FROM rancher/hardened-crictl:v1.29.0-build20240812 AS crictl
FROM rancher/hardened-runc:v1.1.14-build20240903 AS runc
